...
var finalURL = `https://youtube.googleapis.com/youtube/v3/search?part=snippet&channelId=UClWdukQ7nkStbc5rqdtkp_g&maxResults=20&order=date&key=${API_KEY}`
    ...
    render() {
        ...
        return(
            <div className="rowstyle">
                <button className="button" onClick={this.clicked}>Get Buckets Videos</button>
