...
var finalURL = `https://youtube.googleapis.com/youtube/v3/search?part=snippet&channelId=UC2ozVs4pg2K3uFLw6-0ayCQ&maxResults=20&order=date&key=${API_KEY}`
    ...
    render() {
        ...
        return(
            <div className="rowstyle">
                <button className="button" onClick={this.clicked}>Shotime Basketball Videos</button>
